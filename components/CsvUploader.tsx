      ...
      <div className="space-y-4">
        ...
        <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded-lg">
          ...
          <code className="text-xs bg-white p-2 rounded block">
            NO.,トラック名,車両価格,車両価格(税込),業販金額,ボディタイプ,メーカー,大きさ,車種,型式,年式,走行距離（㎞）,積載量（kg）,ミッション,シフト,車検状態,車検有効期限,外寸長（㎜）,外寸幅（㎜）,外寸高（㎜）,車両総重量（kg）,原動機型式,馬力（ps）,ターボ,排気量（cc）,燃料,問い合わせ番号,車体番号,上物メーカー,上物型式,上物年式,装備・仕様（右記以外の）,ETC,バックカメラ,記録簿,パワーウィンドウ,ドラレコ,エアコン,電動ミラー,ABS,アルミホイール,エアサスシート,カーナビ,DPF,PMマフラー,集中ドアロック,内寸長（㎜）,内寸幅（㎜）,内寸高（㎜）,在庫店舗名
          </code>
